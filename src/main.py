...
if __name__=="__main__":
    ...
    probability_distribution = [0.5, 0.4, 1/3, 1/3, 1/3]
    ...
    questions = get_query_questions("hh-rlhf", count=10)

    community.envolute(
        multiple_rounds=5,
        is_target_agent=lambda a: isinstance(a, PersonGPTAgent) and a.model_name == "Llama_v1"
    )
